...
export default function Login() {
  ...
  React.useEffect(() => {
    // Quando o usuário loga ou cria conta, forçamos o React Router a reavaliar.
    // Assim que a auth store tem `user`, navegamos pra raiz. Se não tiver acesso,
    // o SubscriptionGuard vai interceptar e jogar para o /pricing de qualquer maneira.
    if (user) {
      navigate('/');
    }
  }, [user, navigate]);
          ...
          <div className="form-content">
            {view === 'login' ? (
              <div className="login-view fade-in">
                ...
                <p className="instruction">Entre com seu e-mail e senha.</p>
